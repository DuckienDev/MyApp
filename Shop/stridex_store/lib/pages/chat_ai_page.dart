...
import 'package:stridex_store/models/shoes.dart';
  ...
  Future<void> _sendInitialMessage() async {
    ...
    try {
      ...
      String shoeList = featShoe
          ...
          .join("\n");
      String initialText =
          "Bạn là nhân viên bán giày của STRIDEX STORE. Khi khách hàng ghé vào cửa hàng, nhiệm vụ đầu tiên của bạn là **chỉ chào hỏi họ** một cách thân thiện."
